...
namespace FirstContact
{
    ...
    class FormRegionHookup : Outlook.FormRegionStartup
	{
    	private Outlook.FormRegion FormRegion;
        private UserForm UserForm;
        private Outlook.OlkCommandButton CommandButton1;
        private Outlook.OlkCommandButton CommandButton2;
        ...
        Outlook.Enums.OlFormRegionMode FormRegionMode, Outlook.Enums.OlFormRegionSize FormRegionSize)
        {
        ...
        public void BeforeFormRegionShow(Outlook.FormRegion FormRegion)
        {
            ...
            try
            {
                ...
                CommandButton1.ClickEvent += new Outlook.OlkCommandButton_ClickEventHandler(CommandButton1_Click);
                CommandButton2 = UserForm.Controls.Item("CommandButton2") as Outlook.OlkCommandButton;
                CommandButton2.ClickEvent += new Outlook.OlkCommandButton_ClickEventHandler(CommandButton2_Click);
            }
            catch (Exception ex)
            {
        ...
        public object GetFormRegionIcon(string formRegionName, int LCID, Outlook.Enums.OlFormRegionIcon icon)
        {
            throw new Exception("The method or operation is not implemented.");
        }
